...
\definecolor{crhblue}{HTML}{173B70}
\definecolor{crhgold}{HTML}{C59A3D}
...
\begin{titlepage}
  ...
  \begin{center}
    \vspace*{0.65cm}
    {\color{crhblue}\small\bfseries\MakeUppercase{Final Year Project Report}\par}
    \vspace{0.28cm}
    {\color{crhgold}\rule{4.6cm}{0.8pt}\par}
    \vspace{0.95cm}
