...
\reportfig[0.98]{workflow-diagram.pdf}{Overall system workflow,
simplified from the project's detailed draw.io design}{fig:workflow}
...
\reportfig[0.98]{erd-diagram.pdf}{Entity--relationship diagram of the
twelve MongoDB collections, simplified from the draw.io design}{fig:erd}
