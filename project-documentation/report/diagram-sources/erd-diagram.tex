...
\definecolor{chat}{HTML}{FFFFFF}
\definecolor{security}{HTML}{FFFFFF}
\definecolor{ai}{HTML}{F5F5F5}
\tikzset{
...
\begin{tikzpicture}[node distance=9mm and 12mm]
  ...
  \node[entity,below=14mm of user,fill=white] (club) {
    \entitytitle{CLUB}\textbf{PK} \_id\\\textit{FK} createdBy, members.user\\joinPolicy, joinRequests[]};
  \node[entity,below right=14mm and 12mm of user,fill=white] (notification) {
