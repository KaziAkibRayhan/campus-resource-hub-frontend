...
\newcommand{\ExaminerAName}{Moinuddin}
\newcommand{\ExaminerBName}{Rakibul Hasan}
...
% Full-page diagrams use a conservative portrait-page printable area.
\newcommand{\reportwidefig}[4][0.92]{%
  \begin{figure}[H]
    \centering
    \IfFileExists{figures/#2}%
      {\fbox{\includegraphics[width=#1\linewidth]{figures/#2}}}%
...
\vspace{1.6cm}
2.\ \ExaminerAName \hfill (Examiner)

\vspace{1.6cm}
3.\ \ExaminerBName \hfill (Examiner)
